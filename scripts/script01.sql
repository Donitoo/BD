...
-- Order
-- Bread
-- Order_item(Order+Bread)
-- Return
-- Return_item (Bread+Return)

create tablespace LupitaBakery
  datafile 'c:\app\oradata\orcl\LupitaBakery.dbf' 
  size 100m AUTOEXTEND ON
  segment space management auto
  EXTENT MANAGEMENT LOCAL
;

CREATE USER LupitaBakery PROFILE DEFAULT IDENTIFIED BY 12345 
DEFAULT TABLESPACE LupitaBakery TEMPORARY TABLESPACE TEMP ACCOUNT UNLOCK;

GRANT CONNECT TO LupitaBakery;
GRANT RESOURCE TO LupitaBakery;
ALTER USER LupitaBakery QUOTA UNLIMITED ON LupitaBakery;
