...
insert into Return (return_id,client_id,fecha,bread_quantity,total) values ('100','102',20,3);
insert into Return (return_id,client_id,fecha,bread_quantity,total) values ('101','107',10,1.5);
insert into Return (return_id,client_id,fecha,bread_quantity,total) values ('102','108',30,4.5);
